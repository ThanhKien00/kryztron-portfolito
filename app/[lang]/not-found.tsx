...
export default async function NotFound() {
  ...
  return (
    <div className="container-swiss flex min-h-[60vh] flex-col justify-center py-20">
      ...
      <Link
        href={`/${defaultLocale}`}
        className="mt-8 inline-flex min-h-11 w-fit items-center rounded-swiss border border-border-strong px-5 text-sm font-medium transition-colors hover:bg-muted"
      >
        {dict.notFound.back}
      </Link>
    </div>
